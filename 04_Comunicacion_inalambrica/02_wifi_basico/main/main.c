...
static const char index_html[] =
    ...
    "<div>"
    "<div class='title'>Practica 3 - WiFi Básico</div>"
    "<div class='sub'>Instrumentación Electronica - UNAL</div>"
    "</div>"
    "</div>"
    ...
    "<div class='sect'>"
    "<div class='sect-hdr'>"
    "<span class='sect-title'>ADC Canal 4 — Potenciómetro</span>"
    ...
    "</div>"
    "</div>"
    "<div class='ftr'>Universidad Nacional de Colombia - Ingeniería Electronica - 2026</div>"
    "</div>"
    "<script>"
    "(function(){"
    ...
    "}"
    "function rLabel(r){"
    "return r>=-55?'Excelente':r>=-70?'Bueno':r>=-80?'Regular':'Débil';"
    "}"
    "function flash(id){"
